...
# Step 06: Compute forecast error----
# Forecast error = Actual - Forecast (MA)
# Note: Only valid where MA is not NA
forecast_error <- data - ma_3

#***************************************************************

# Step 07: Display forecasted values and errors as tibble----
forecast_tbl <- tibble(
    Time = 1:length(data),
    Original = data,
    MA_3 = round(ma_3, 2),
